  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: '#001d3d',
          border: '1px solid rgba(101,12,217,0.18)',
          boxShadow: '0 8px 40px rgba(0,0,0,0.50)',
        }}
        animate={{
          boxShadow: [
            '0 8px 40px rgba(0,0,0,0.50)',
            '0 12px 48px rgba(101,12,217,0.15), 0 8px 40px rgba(0,0,0,0.40)',
            '0 8px 40px rgba(0,0,0,0.50)',
          ],
        }}
      ...
      >
        <Link href="/join" className="group flex items-center justify-between gap-4">
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, #bfa8ff 0%, #8f63ff 100%)',
              boxShadow: '0 8px 24px rgba(101,12,217,0.45)',
            }}
            animate={{
              boxShadow: [
                '0 8px 24px rgba(101,12,217,0.40)',
                '0 8px 36px rgba(101,12,217,0.75)',
                '0 8px 24px rgba(101,12,217,0.40)',
              ],
              rotate: [0, -2, 2, -1, 0],
            }}
          ...
          <div className="flex-1 flex flex-col items-start gap-1.5">
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 4px 14px rgba(101,12,217,0.45)',
              }}
              animate={{ y: [0, -1, 0] }}
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 0 18px rgba(101,12,217,0.25)',
              }}
              animate={{
                boxShadow: [
                  '0 0 14px rgba(101,12,217,0.20)',
                  '0 0 28px rgba(101,12,217,0.55)',
                  '0 0 14px rgba(101,12,217,0.20)',
                ],
              }}
          ...
          <div
            ...
            style={{
              background: 'rgba(101,12,217,0.12)',
              border: '1px solid rgba(101,12,217,0.24)',
            }}
          >
            <p className="text-[10px] uppercase tracking-wider font-bold" style={{ color: 'rgba(255,255,255,0.60)' }}>
              Try code
            </p>
            <p className="text-base font-black tracking-widest" style={{ color: '#8f63ff' }}>
              LZ-4729
            </p>
          </div>
        </Link>
  ...
  return (
    ...
    >
      {trustItems.map(item => (
        ...
        >
          <item.icon className="w-3.5 h-3.5" style={{ color: '#8f63ff' }} />
          {item.label}
        </div>
      ))}
    </motion.div>
...
function MockDashboardCard() {
  ...
  const barColors = ['#bfa8ff', '#8f63ff', '#1e96fc', '#bfa8ff']
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.35 }}>
      <div
        ...
        style={{
          background: '#001d3d',
          border: '1px solid rgba(101,12,217,0.15)',
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl" style={{ background: '#bfa8ff', color: '#000814' }}>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: 'Responses', value: '47', bg: '#bfa8ff', text: '#000814' },
            { label: 'Engagement', value: '92%', bg: '#003566', text: '#bfa8ff' },
        ...
        <div className="space-y-2">
          {[
            ...
            >
              ...
              <div className="flex items-center gap-1 text-xs font-bold" style={{ color: '#bfa8ff' }}>
        ...
        <div className="flex items-center justify-between rounded-xl px-4 py-2.5" style={{ background: 'rgba(101,12,217,0.08)', border: '1px solid rgba(101,12,217,0.20)' }}>
          <div>
            <p className="text-[10px]" style={{ color: 'rgba(255,255,255,0.40)' }}>
              Join with code
            </p>
            <p className="text-lg font-bold tracking-widest" style={{ color: '#bfa8ff' }}>
              LZ-7A29
            </p>
          </div>
          <CheckCircle2 className="w-5 h-5" style={{ color: '#bfa8ff' }} />
        </div>
      </div>
    </motion.div>
  )
...
export default function HeroSection() {
  const featurePills = [
    { label: 'Live polls', icon: Radio, bg: 'rgba(101,12,217,0.15)', text: '#bfa8ff', border: 'rgba(101,12,217,0.30)' },
    { label: 'Quizzes', icon: Trophy, bg: 'rgba(143,99,255,0.12)', text: '#8f63ff', border: 'rgba(143,99,255,0.25)' },
    { label: 'Word clouds', icon: Cloud, bg: 'rgba(30,150,252,0.12)', text: '#1e96fc', border: 'rgba(30,150,252,0.25)' },
    { label: 'Q&A', icon: MessageSquare, bg: 'rgba(101,12,217,0.10)', text: '#bfa8ff', border: 'rgba(101,12,217,0.20)' },
  ]
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 80% 50% at 60% 40%, rgba(101,12,217,0.06) 0%, transparent 70%)' }}
      />
          ...
          >
            <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              <span
                ...
                style={{ background: 'rgba(101,12,217,0.12)', color: '#bfa8ff', border: '1px solid rgba(101,12,217,0.25)' }}
              >
